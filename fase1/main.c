...
int main () {
    ...
    int sel = -1, target = -1, timer1 = 0, timer2 = 0, clk = 0, timer3 = 0, interval1 = 50, interval2 = 20, idx = 0, life = 120, scroll1 = 0, cura, opacidade1 = 0, opacidade2 = 0, scroll2 = 0;
    ...
    while (WindowShouldClose() == false && end == false && timer3 < 120){
        ...
        if (up_life == true){
            DrawUpLife(str_cura, &up_life, &opacidade1, &scroll1);
        }
        if (down_life == true){
